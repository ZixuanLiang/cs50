...
ASaysKnight = Symbol("A says he is a knight")
AsaysKnave = Symbol("A says he is a knave")
knowledge3 = And(
    # TODO
    Or(AKnight, AKnave),
    Or(BKnight, BKnave),
    ...
    Or(AsaysKnave, ASaysKnight),
    Not(And(AsaysKnave, ASaysKnight)),
    Implication(AKnight, ASaysKnight),
    Implication(AKnave, ASaysKnight),
    Implication(BKnight, And(AsaysKnave, CKnave)),
    Implication(BKnave, And(Not(AsaysKnave), Not(CKnave))),
